...
Een zakelijke samenvatting voor de docent. Gebruik EXACT deze drie bulletpoints (inclusief de vetgedrukte labels):
- **Onderwerp:** Beschrijf in 2-3 zinnen de kern van de behandelde paragrafen. Benoem wat er inhoudelijk aan bod komt voor deze leeftijdsgroep en dit niveau.
...
Korte thema-tags (1 tot maximaal 3 woorden per stuk) die de lading van de reeks dekken.
- Voorbeeld: ["Koude Oorlog", "Propaganda", "Ideologieën", "Machtsevenwicht"].

KWALITEITSEISEN (Strikt toepassen)
- Docentgericht en zakelijk: Schrijf alsof je een collega-docent informeert. Houd de toon professioneel en feitelijk.
- Geen verkooppraatjes: Vermijd wervende, ophemende of enthousiaste taal. Gebruik GEEN woorden als "fascinerend", "indrukwekkend", "boeiend", "prachtig", "uniek", "krachtig" of vergelijkbare superlatieven en sfeerversterkende bijvoeglijke naamwoorden. Beschrijf gewoon wat er aan bod komt, zonder het mooier te maken dan het is.
- Maatwerk is verplicht: Gebruik de aangeleverde ruwe data (boek, niveau, klasgrootte, notities van de docent) als absolute leidraad. De didactische aanpak moet concreet aansluiten bij de doelgroep; vermijd algemene didactische clichés.
